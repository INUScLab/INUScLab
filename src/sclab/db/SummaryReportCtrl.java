...
public class SummaryReportCtrl {
	...
	public ArrayList<SummaryReport> getSummaryReportList ( String address ) {
		...
		try {
			...
			while (rs.next()) {
				...
				System.out.println(dongSummaryReport);
